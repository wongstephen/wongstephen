...
<div>
   ...
   <p><b>Javascript, React, and Headless CMS</b> - <br /> 
      Created for local business to serve as proof of concept in developing an easily maintainable app that can be updated by the business owners via Wordpress.
   </p>
